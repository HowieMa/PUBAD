...
class BasicBlock(nn.Module):
    ...
    def forward(self, x, residual=None):
        ...
        out = self.relu(self.bn1(self.conv1(x)))        # 3x3 conv
        out = self.bn2(self.conv2(out))                 # 3x3 conv
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x, residual=None):
        ...
        out = self.relu(self.bn1(self.conv1(x)))        # 1x1 conv
...
def DLAv0_34(heads, num_layers='60', head_conv=256, down_ratio=4):
...
if __name__ == "__main__":
    num_class = 1
    net = DLAv0_34(heads={'hm': num_class, 'wh': 7})
